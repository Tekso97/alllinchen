...
const CONFIG = {
    ...
    valentineName: "BumBee",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Geheim, musst du schon selbst herausfinden 🫶",
    ...
    questions: {
        ...
        second: {
            ...
            startText: "hier angeben",                                   // Text before the percentage
            nextBtn: "Weiter"                                         // Text for the next button
        },
        third: {
            text: "Willst du mein Valentinsdate sein am 14.02.2026? 🌹", // The big question!
            yesBtn: "Ja!",                                             // Text for "Yes" button
            noBtn: "Nein"                                                 // Text for "No" button
        }
    },
